...
Este repositório contem o esqueleto de um projeto mojolicious alterado para seguir o padrão interno dos projetos da empresa Bivee e para 
...
Fizemos apenas algumas adaptações e criamos alguns diretórios, renomeamos arquivos e criamos paths para organizar de forma mais 
"intuitiva" a estrutura padrão do esqueleto do projeto de mojolicious non-lite.
